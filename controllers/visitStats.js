...
const processVisit = async (req, res) => {
  // const ip = req.ip;
  // console.log(ip);
  ...
  res.json(visit);
  // return any text but not the VISIT variable
};
...
export default {
  processVisit: ctrlWrapper(processVisit),
  getVisitStats: ctrlWrapper(getVisitStats),
};
